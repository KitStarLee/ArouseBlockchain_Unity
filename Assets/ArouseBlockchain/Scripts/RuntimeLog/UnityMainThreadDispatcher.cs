...
public class UnityMainThreadDispatcher : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="action">function that will be executed from the main thread.</param>
    public void Enqueue<T>(Action<T> action, T t)
    {
        Enqueue(ActionWrapper(action,t));
    }
    ...
    public Task EnqueueAsync<T>(Action<T> action, T t)
    {
        var tcs = new TaskCompletionSource<bool>();
    ...
    IEnumerator ActionWrapper<T>(Action<T> a,T t)
    {
        a(t);
        yield return null;
    }
